class Kombi {
    ...
    void create() {
        ...
        */
        ...
        fill(primaryColor);
        arc(centerX, roofHeight, kombiWidth*0.9, 2*roofHeight, PI, 2*PI);
        ...
        pushMatrix();
        /* Set the left side of the roof as reference */
        translate(kombiWidth*0.05, 0);
        line(kombiWidth*0.05, roofHeight, 0, greenhouseHeight);
        line(kombiWidth*0.85, roofHeight, kombiWidth*0.9, greenhouseHeight);

        translate(-kombiWidth*0.05, greenhouseHeight);
        line(kombiWidth*0.05, 0, kombiWidth*0.05, frontHeight);
        line(kombiWidth*0.95, 0, kombiWidth*0.95, frontHeight);
        popMatrix();

        pushMatrix();
        translate(0, kombiHeight-bumperHeight);
        /* Bumper */
        fill(tertiaryColor);
        rect(-kombiWidth*0.02, 0, kombiWidth*1.04, bumperHeight, 10);
        rect(kombiWidth*0.25, -bumperHeight/2, bumperHeight/2, bumperHeight*2, 10);
        rect(kombiWidth*0.75-bumperHeight/2, -bumperHeight/2, bumperHeight/2, bumperHeight*2, 10);

        /* License plate */   
        /* TODO: Rework */    
        fill(255);
        rect(centerX-licensePlateWidth/2, kombiHeight*0.005, licensePlateWidth, bumperHeight-kombiHeight*0.01);
        fill(0);
        textAlign(CENTER);
        textSize(bumperHeight*0.8);
        text("ABC-1234", centerX, bumperHeight*0.75);
        popMatrix();
